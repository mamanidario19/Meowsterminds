/* En esta clase controlamos los Ojos del jugador*/ 
...
public class VisionController : MonoBehaviour
{
    ...
    private NavMeshController navMeshController; //Variable q hace ref al controlador NavMeshController
    ...
    public bool CanSeePlayer(out RaycastHit hit, bool lookPlayer = false)
    {
        Vector3 vectorDirection;
        if (lookPlayer) //Si miramos al jugador
        {
            
            vectorDirection = (navMeshController.followTarget.position + offset) - Eyes.position;//Pos de jugador restamos la pos de ojos
        }else
        {
            vectorDirection = Eyes.forward; //Direccion de los ojos hacia adelante
        }
        ...
        //&& y es verdadero que tenga el tag player
    }
}
