...
public class CharacterInput : MonoBehaviour
{
    ...
    //En este update estableceremos unas condicionales que evaluen c�ando van a poder se llamadas sus respectivas funciones ya predefinidas,
    //tambi�n almacenamos los valores en X e Y desde sus GetAxis//
    void Update()
    {
